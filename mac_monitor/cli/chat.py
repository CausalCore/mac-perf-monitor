...
def run_chat(prompt=None):
    ...
    cause_str = ", ".join([r["cause"] for r in roots]) if roots else "No specific process bottlenecks."
    ...
    user_prompt = prompt if prompt else "Mac'im şu an neden yavaş hissettiriyor olabilir? Kısa ve öz bir özet yap."
    ...
    try:
        with urllib.request.urlopen(req, timeout=15) as response:
            ...
            console.print(Panel(Markdown(answer), title="AuraMac AI", border_style="green"))
