...
def run_clean_scan():
    console.print(
        "[bold cyan]Scanning for System Bloat (Hidden Caches)...[/bold cyan]\n"
    )
    ...
    if total_bloat == 0:
        console.print(
            "[green]Your system is remarkably clean! No major hidden bloat found.[/green]"
        )
    else:
        console.print(table)
        console.print(
        ...
        console.print(
            "[dim]Run the commands above manually to free up space and reduce Disk IO load.[/dim]"
        )
