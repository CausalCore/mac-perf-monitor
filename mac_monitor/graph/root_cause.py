def extract_root_causes(graph, top_k=3):
    ...
    candidates = [
        n for n in graph.nodes.values() if n.type == "PROCESS" and n.influence_score > 0
    ]
